...
- [Installing software using conda](https://nvi-documentation.readthedocs.io/en/latest/tools/installing_software_using_conda.html)
...
In the project directory, yalm files can be found here (have a look):
```{.bash}
ls /cluster/projects/nn9305k/src/miniconda/yaml_files
clear
cat /cluster/projects/nn9305k/src/miniconda/yaml_files/checkm_2.yml
```

Conda documentation for [yalm files](https://docs.conda.io/projects/conda-build/en/latest/resources/define-metadata.html)
