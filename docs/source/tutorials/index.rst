...
.. toctree::
   :maxdepth: 1
    ...
    First time on SAGA <03-saga_first_time.md>
    How to do a Blast job on SAGA <04-blast_tutorial.md>
    Install nextflow pipelines on SAGA <05-install_nf_pipelines_saga.md>
    How to remove contamination from NGS sequence data <06-contamination_ngs.md>
